...
export const notifications = pgTable(
	...
	(table) => [index("idx_notifications_user_read").on(table.userId, table.readAt)],
);

export const reportsRelations = relations(reports, ({ one }) => ({
	question: one(questions, { fields: [reports.questionId], references: [questions.id] }),
...
export const notificationsRelations = relations(notifications, ({ one }) => ({
	...
	question: one(questions, { fields: [notifications.questionId], references: [questions.id] }),
